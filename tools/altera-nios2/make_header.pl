#!/bin/perl
################################################################################
# This script generates a header with the given information and calculates the
# file's and header CRC.
#
# This script is borrowed from Altera's AN458 reference design.
# Please refer to AN458 for details!
################################################################################
